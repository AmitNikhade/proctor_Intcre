...
ice_servers = [
    ...
    RTCIceServer(urls='turn:global.turn.twilio.com:3478?transport=udp', 
                 username='ab8bc3cbd755d15bae4ca6d57fed2499a74e67029ef0bb1c0dcd7938b102d4c2', 
                 credential='zVM5wESoNbVJJNjcrgUUWYkmNdVqENIChGRmPzzOOmg='),  # TURN server with UDP transport
    RTCIceServer(urls='turn:global.turn.twilio.com:3478?transport=tcp', 
                 username='ab8bc3cbd755d15bae4ca6d57fed2499a74e67029ef0bb1c0dcd7938b102d4c2', 
                 credential='zVM5wESoNbVJJNjcrgUUWYkmNdVqENIChGRmPzzOOmg='),  # TURN server with TCP transport
    RTCIceServer(urls='turn:global.turn.twilio.com:443?transport=tcp', 
                 username='ab8bc3cbd755d15bae4ca6d57fed2499a74e67029ef0bb1c0dcd7938b102d4c2', 
                 credential='zVM5wESoNbVJJNjcrgUUWYkmNdVqENIChGRmPzzOOmg=')   # TURN server with TCP transport on port 443
]
